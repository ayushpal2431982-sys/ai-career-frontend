...
const Login = () => {
  ...
  return (
    <div className="bg-page flex items-center justify-center p-4">
      ...
      <div
        className="orb w-64 h-64 bg-violet-600 top-1/2 left-1/2
        -translate-x-1/2"
      />

      <div
        className="glass-card w-full max-w-md p-10 flex flex-col
        items-center gap-8 z-10"
      >
        <div className="flex flex-col items-center gap-3 text-center">
          <div
            className="w-12 h-12 rounded-xl bg-linear-to-br
                from-indigo-500 to-emerald-400 flex items-center justify-center
        ...
        <div className="w-full flex flex-col gap-2">
          <p
            className="text-center text-xs text-white/30 uppercase
            tracking-widest font-medium"
          >
            Continue With
          </p>
          <button className="btn-google" onClick={googleLogin} disabled=
          {loading}>
            {loading ? (
